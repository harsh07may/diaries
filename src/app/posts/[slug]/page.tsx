...
export default function PostPage({
  ...
  return (
    <motion.div
      className="bg-background min-h-screen flex flex-col font-sans text-body-md"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <main className="grow w-full max-w-max-width mx-auto px-margin-page py-gap-lg flex flex-col md:flex-row gap-gap-lg">
        <article className="w-full md:w-8/12 flex flex-col gap-gap-lg">
          ...
          <div className="flex flex-col gap-gap-md font-sans text-body-md">
          ...
          <div className="flex items-center gap-gap-sm pt-gap-md border-t-[3px] border-ink">
            ...
            <button className="w-10 h-10 border-[3px] border-ink bg-surface flex items-center justify-center shadow-brutal hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none active:translate-x-1 active:translate-y-1 transition-all">
              ↗
            </button>
            <button className="w-10 h-10 border-[3px] border-ink bg-info text-white flex items-center justify-center shadow-brutal hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none active:translate-x-1 active:translate-y-1 transition-all">
              𝕏
            </button>
          </div>
        </article>
