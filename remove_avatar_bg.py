...
def is_white(pixel):
    # Check if pixel is close to white/off-white
    r, g, b, a = pixel
    # The background might be slightly yellowish off-white
    return r > 230 and g > 230 and b > 220 and a > 0
...
def remove_background(image_path, output_path):
    ...
    # Also crop the image to its bounding box of non-transparent pixels
    bbox = img.getbbox()
    if bbox:
        img = img.crop(bbox)
